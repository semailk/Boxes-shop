...
<!--                                                                --><?php //$subCategories = \App\Models\Category::where('parent_id', $category->id)->get() ?>
                                                                            ...
                                                                            <div class="filter-categories-alt__children"
                                                                                ...
                                                                                <ul class="filter-categories-alt__list filter-categories-alt__list--level--3">
                                                                                    ...
                                                                                    <li class="filter-categories-alt__item filter-categories-alt__item--current"
                                                                                        ...
                                                                                        <a href="">Deep Dive</a>
                                                                                        <div
                                                                                            class="filter-categories-alt__children"
                                                                                            data-collapse-content>
                                                ...
                                                <div class="filter__container">
                                                    <div class="filter-list">
                                                        <div class="filter-list__list">
                                                            <form action="{{route('brand.filter')}}" method="GET">
                                                                @foreach($brands as $brand)
                                                                    <label class="filter-list__item ">
                                                                        <span class="filter-list__input input-check">
                                                                            <span class="input-check__body">
                                                                                <input name="{{$brand->id}}"
                                                                                       ...
                                                                                       @if(request()->has($brand->id)) checked
                                                                                       @endif  type="checkbox">
                                                                        ...
                                                                        <span
                                                                            class="filter-list__counter">{{count($brand->products)}}</span>
                                                                    </label>
                                                            {{--                                                                    <label class="filter-list__item ">--}}
                                                            {{--                                                                        <span class="filter-list__input input-check">--}}
                                                            {{--                                                                            <span class="input-check__body">--}}
                                ...
                                <div class="widget-filters__actions d-flex">
                                    <button class="btn btn-primary btn-sm Filter-Button">Filter</button>
                        ...
                        <div class="block-sidebar__item d-none d-lg-block">
                            <div class="widget-products widget">
                                ...
                                <div class="widget-products__list">
                                                    ...
                                                    <a href="{{route('getProduct', $product->id)}}"
                                                       class="product-image__body">
                                                        <img class="product-image__img"
                                                             src="{{isset($product->gallery[0]) ? asset('storage/' . $product->gallery[0]) : asset('../images/no-image.jpg')}}"
                                                             alt="">
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    {{--                                        <div class="widget-products__info">--}}
                                    {{--                                            <div class="widget-products__name">--}}
                                    {{--                                                <a href="product.blade.php">Undefined Tool IRadix DPS3000SY 2700--}}
                                    {{--                                                    Watts</a>--}}
                                    {{--                                            </div>--}}
                                    {{--                                            <div class="widget-products__prices">--}}
                                    {{--                                                $1,019.00--}}
                                    ...
                                    {{--                                        <div class="widget-products__info">--}}
                                    {{--                                            <div class="widget-products__name">--}}
                                    {{--                                                <a href="product.blade.php">Drill Screwdriver Brandix ALX7054 200--}}
                                    {{--                                                    Watts</a>--}}
                                    {{--                                            </div>--}}
                                    {{--                                            <div class="widget-products__prices">--}}
                                    {{--                                                $850.00--}}
                                    ...
                                    {{--                                        <div class="widget-products__info">--}}
                                    {{--                                            <div class="widget-products__name">--}}
                                    {{--                                                <a href="product.blade.php">Drill Series 3 Brandix KSR4590PQS 1500--}}
                                    {{--                                                    Watts</a>--}}
                                    {{--                                            </div>--}}
                                    {{--                                            <div class="widget-products__prices">--}}
                        ...
                        <div class="products-view__options">
                            <div class="view-options view-options--offcanvas--mobile">
                                ...
                                <div class="view-options__control">
                                    ...
                                    <div>
                                        <select class="form-control form-control-sm" name="" id="pagination-select">
                                        ...
                                        <div class="product-card product-card--hidden-actions ">
                                            ...
                                            <div class="product-card__info">
                                                ...
                                                <div class="product-card__rating">
                                                    ...
                                                    <div
                                                        class="product-card__rating-legend">{{count($product->reviews)}}
                                                        Reviews
                                                    </div>
                                                </div>
                                            ...
                                            <div class="product-card__actions">
                                                <div class="product-card__availability">
                                                    <span
                                                        class="{{$product->stock_status == 0 ? 'text-danger' : 'text-success'}}">{{\App\Enums\ProductStockStatus::fromValue($product->stock_status)->description}}</span>
                                                </div>
