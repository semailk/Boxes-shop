                            ...
                            <a class="block-slideshow__slide" href="">
                                ...
                                <div class="block-slideshow__slide-content">
                                    <div class="block-slideshow__slide-title">
                                        <h1>{{\Illuminate\Support\Facades\App::getLocale()}}</h1><br>Plumbing products
                                    </div>
                                    ...
                                    <div class="product-card product-card--hidden-actions ">
                                            ...
                                            <a href="{{route('getProduct', $product->id)}}" class="product-image__body">
                                                @if(isset($product->gallery[0]))
                                                    <img class="product-image__img"
                                                         src="{{asset('storage/' . $product->gallery[0])}}" alt="">
                                                @else
                                                    <img class="product-image__img"
                                                         src="{{asset('../images/no-image.jpg')}}" alt="">
                                                @endif
                                            </a>
                                        </div>
                                                ...
                                                <div class="product-card__rating-stars">
                                                    <div class="rating">
                                                        <div class="rating__body">
                                                            <?php $noStars = 5;
                                                            $noStars = $noStars - $product->reviews->avg('rating');
                                                            ?>
                                        ...
                                        <div class="product-card__actions">
                                            ...
                                            <div class="product-card__buttons">
                                                <button data-product-id="{{$product->id}}" id="details_id"
                                ...
                                <div class="block-products-carousel__cell">
                                    <div class="product-card product-card--hidden-actions ">
                                        ...
                                        <div class="product-card__actions">
                                            ...
                                            <div class="product-card__prices">
                                                <span
                                                    class="product-card__new-price">₴{{$product->sale_percentage}}</span>
                                                <span class="product-card__old-price">₴{{$product->regular_price}}</span>
                                            </div>
                                            <div class="product-card__buttons">
                ...
                <div class="block-products__featured">
                    <div class="block-products__featured-item">
                        <div class="product-card product-card--hidden-actions ">
                            ...
                            <div class="product-card__image product-image">
                                <a href="{{route('getProduct', $newProduct->id)}}" class="product-image__body">
                                    <img class="product-image__img"
                                         src="{{isset($newProduct->gallery[0])? asset('storage/' . $newProduct->gallery[0]) : asset('../images/no-image.png')}}" alt="">
                                </a>
                            </div>
                            <div class="product-card__info">
                                <div class="product-card__name">
                                    <a href="{{route('getProduct', $newProduct->id)}}">{{$newProduct->name}}</a>
                                </div>
                                <div class="product-card__rating">
                                    <div class="product-card__rating-stars">
                                        <div class="rating">
                            ...
                            <div class="block-products__list-item">
                                <div class="product-card product-card--hidden-actions ">
                                    ...
                                    <div class="product-card__image product-image">
                                        <a href="{{route('getProduct', $product->id)}}" class="product-image__body">
                                            <img class="product-image__img"
                                                 src="{{!isset($product->gallery[0]) ? asset('../images/no-image.jpg') : asset('storage/' . $product->gallery[0])}}"
                                                 alt="">
                                        </a>
                                    </div>
                                    <div class="product-card__info">
                                        <div class="product-card__name">
                                            <a href="{{route('getProduct', $newProduct->id)}}">{{$product->name}}</a>
                                        </div>
                                        <div class="product-card__rating">
                                            <div class="product-card__rating-stars">
                                                <div class="rating">
                            ...
                            <div class="block-products__list-item">
                                <div class="product-card product-card--hidden-actions ">
                                    ...
                                    <div class="product-card__actions">
                                        ...
                                        <div class="product-card__prices">
                                            <span class="product-card__new-price">₴{{$product->sale_percentage}}</span>
                                            <span class="product-card__old-price">₴{{$product->regular_price}}</span>
                                        </div>
                                        <div class="product-card__buttons">
                                            <button class="btn btn-primary product-card__addtocart" type="button">Add To
                    ...
                    @foreach($newArrivals as $arrival)
                        <div class="block-products-carousel__cell">
                            <div class="product-card product-card--hidden-actions ">
                                ...
                                <div class="product-card__image product-image">
                                    <a href="{{route('getProduct', $arrival->id)}}" class="product-image__body">
                                        <img class="product-image__img"
                                             src="{{isset($arrival->gallery[0]) ? asset('storage/' . $arrival->gallery[0]) : asset('../images/no-image.jpg')}}"
                                             alt="">
                                    </a>
                                </div>
                                <div class="product-card__info">
                                    <div class="product-card__name">
                                        <a href="{{route('getProduct', $arrival->id)}}">{{$arrival->name}}</a>
                                    </div>
                                    <div class="product-card__rating">
                                        <div class="product-card__rating-stars">
                                            <div class="rating">
                                        ...
                                        <div class="product-card__rating-legend">{{count($arrival->reviews)}}
                                            Reviews
                                        </div>
                                    </div>
                                    <ul class="product-card__features-list">
            ...
            <div class="row">
                <div class="col-4">
                    ...
                    <div class="block-product-columns__column">
                        @foreach($topReadProducts as $review)
                            <div class="block-product-columns__item">
                                <div class="product-card product-card--hidden-actions product-card--layout--horizontal">
                                    ...
                                    <div class="product-card__image product-image">
                                        <a href="{{route('getProduct', $review->product->id)}}" class="product-image__body">
                                            <img class="product-image__img"
                                                 src="{{ isset($review->product->gallery[0]) ? asset('storage/' . isset($review->product->gallery[0])) : asset('../images/no-image.jpg') }}"
                                                 alt="">
                                        </a>
                                    </div>
                                    <div class="product-card__info">
                                        <div class="product-card__name">
                                            <a href="{{route('getProduct', $review->product->id)}}">{{$review->product->name}}</a>
                                        </div>
                                        <div class="product-card__rating">
                                            <div class="product-card__rating-stars">
                                                <div class="rating">
                                                    <div class="rating__body">
                                                        ...
                                                        {{--                                                    </div>--}}
                                                        <?php $noStars = 5;
                                                        $noStars = $noStars - $review->product->reviews->avg('rating')
                                                        ?>
                                                        @for($i=0; $i < round($review->product->reviews->avg('rating'),PHP_ROUND_HALF_UP); $i++)
                                                            <svg class="rating__star rating__star--active" width="13px"
                                                                 height="12px">
                                                                <g class="rating__fill">
                                                                    <use
                                            ...
                                            <div
                                                class="product-card__rating-legend">{{$review->product->reviews->avg('rating')}}
                                                Reviews
                                            </div>
                                        </div>
                                        <ul class="product-card__features-list">
                            ...
                            <div class="block-product-columns__item">
                                <div
                                    ...
                                    <div class="product-card__image product-image">
                                        <a href="{{route('getProduct', $review->product->id)}}" class="product-image__body">
                                            <img class="product-image__img"
                                                 src="{{ isset($review->product->gallery[0]) ? asset('storage/' . isset($offer->gallery[0])) : asset('../images/no-image.jpg') }}"
                                                 alt="">
                                        </a>
                                    </div>
                                    <div class="product-card__info">
                                        <div class="product-card__name">
                                            <a href="{{route('getProduct', $review->product->id)}}">{{$offer->name}}</a>
                                        </div>
                                        <div class="product-card__rating">
                                            <div class="product-card__rating-stars">
                                                <div class="rating">
                                    ...
                                    <div class="product-card__actions">
                                        ...
                                        <div class="product-card__prices">
                                            <span class="product-card__new-price">₴{{$offer->sale_percentage}}</span>
                                            <span class="product-card__old-price">₴{{$offer->regular_price}}</span>
                                        </div>
                                        <div class="product-card__buttons">
                                            <button class="btn btn-primary product-card__addtocart" type="button">
                                                Add To
                        ...
                        @foreach($bestsellers as $bestseller)
                            <div class="block-product-columns__item">
                                <div class="product-card product-card--hidden-actions product-card--layout--horizontal">
                                    ...
                                    <div class="product-card__image product-image">
                                        <a href="{{route('getProduct' , $bestseller->id)}}" class="product-image__body">
                                            <img class="product-image__img"
                                                 src="{{ isset($review->product->gallery[0]) ? asset('storage/' . isset($bestseller->gallery[0])) : asset('../images/no-image.jpg') }}"
                                                 alt="">
                                        </a>
                                    </div>
                                    <div class="product-card__info">
                                        <div class="product-card__name">
                                            <a href="{{route('getProduct' , $bestseller->id)}}">{{$bestseller->name}}</a>
                                        </div>
                                        <div class="product-card__rating">
                                            <div class="product-card__rating-stars">
                                                <div class="rating">
                                                    <div class="rating__body">
                                                        <?php $noStars = 5;
                                                        $noStars = $noStars - count($bestseller->reviews);
                                                        ?>
                                                        @for($i=0; $i < count($bestseller->reviews); $i++)
                                                            <svg class="rating__star rating__star--active" width="13px"
                                                                 height="12px">
                                                                <g class="rating__fill">
                                                                    <use
                                            ...
                                            <div class="product-card__rating-legend">{{count($bestseller->reviews)}}
                                                Reviews
                                            </div>
                                        </div>
                                        <ul class="product-card__features-list">
                                    ...
                                    <div class="product-card__actions">
                                        ...
                                        <div class="product-card__buttons">
                                            <button data-product-id="{{$bestseller->id}}" class="btn btn-primary product-card__addtocart" type="button">Add To
                                                Cart
                                            </button>
                                            <button
                                              data-product-id="{{$bestseller->id}}"  class="btn btn-secondary product-card__addtocart product-card__addtocart--list"
                                                type="button">Add To Cart
                                            </button>
{{--                                            <button--}}
{{--                                                class="btn btn-light btn-svg-icon btn-svg-icon--fake-svg product-card__wishlist"--}}
